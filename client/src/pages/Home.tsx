...
import { MEETNORMAN_URL, SCORECARD_URL } from "@/lib/constants";
    ...
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <main className="relative z-10 pt-24">
        ...
        <Section id="work" className="border-t border-border/30">
          ...
          <h3 className="text-xl font-semibold tracking-tight mt-12 mb-6 text-muted-foreground">Personal work</h3>
          <div className="grid md:grid-cols-2 gap-6">
            <WorkCard
              id="rob-hutt-films"
